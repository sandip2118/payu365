...
function BankDetails({ onClick }: prop) {
  ...
  const LightBox = ({ children }: any) => {
    return (
      <div className='bg-BLACK_304 mb-[20px] border border-BLACK_306 xs:px-[15px] px-[10px] py-[10px] rounded-[10px]'>
        {children}
      </div>
    )
  }
  ...
  const Items = ({ title, value, className }: any) => {
    return (
        <div className={`flex items-center ${className}`}>
          ...
          <p className='font12RB mx-[15px] max-w-[100px] xs:max-w-xs overflow-hidden text-ellipsis whitespace-nowrap'>{value}</p>
        </div>
    )
  }
    ...
    <div className='mb-5'>
      <Card className='sm:px-5 px-[10px]'>
        ...
        <LightBox>
          ...
          <Items title={'Bank Country'} value={'India'} className='mt-[13px] mb-[5px]' />
        ...
        <LightBox>
          ...
          <Items title={'Account Holder Name'} value={'Mitul K Jetani'} className='mt-[13px] mb-[5px]' />
        ...
        {/* <LightBox>
          ...
          <Items title={'Bank Name'} value={'ICICI Bank'} className='mt-[13px] mb-[5px]' />
          <Items title={'Branch Name'} value={'Gujarat'} className='mb-[5px]' />
          <Items title={'Account No'} value={'15910511256'} className='mb-[5px]' />
          <Items title={'Swift/IFSC Code'} value={'ICICI001'} className='mb-[5px]' />
