  ...
  return (
    ...
    <div className='min-w-full lg:min-w-[580px] mt-[30px]'>
      <Card className='sm:px-5 px-[10px]'>
        ...
        <p className='font12RB mt-5 mb-[10px]'>Transferring money To</p>
        ...
        <div className='bg-BLACK_304 rounded-[5px] py-5 sm:px-5 px-[10px]'>
          <div className=' flex sm:gap-[10px] gap-[5px] items-center justify-between'>
            <div className='flex items-center'>
              ...
              <div className='sm:ml-[10px] ml-[5px]'>
                <p className='font14RB text-white !sm:text-sm !text-xs'>Mahesh Raghvan</p>
                <p className='font12RB text-GRAY_101 mt-1 flex items-center'><Icons.BhimIcon className='mr-1' />maheshraghan@okicici</p>
              </div>
            </div>
