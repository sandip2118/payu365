...
function WrapperQuickBank({ setOptions }: any) {
  ...
  return (
    <>
      ...
      {selectQuickBank === 1 || activeStep === 0 &&
        <QuickBank _bank={(val) => { setSelectQuickBank(val), setOptions(val) }} />
      }
      {selectQuickBank === 1 && activeStep === 0 &&
        < BankDetailsComp activeStep={activeStep} _activeStep={_activeStep} />
      }
      {activeStep === 1 &&
...
export default WrapperQuickBank
