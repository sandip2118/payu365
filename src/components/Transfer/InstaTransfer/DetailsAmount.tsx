        ...
        <div className='bg-BLACK_304 rounded-[5px] py-5 sm:px-5 px-[10px]'>
          <div className=' flex sm:gap-[10px] gap-[5px] items-center justify-between'>
            <div className='flex items-center'>
              <img src={'/assets/images/user3.png'} alt='profile' className='w-[50px] h-[50px] rounded-full bg-GRAY_101' />
              <div className='sm:ml-[10px] ml-[5px]'>
                <p className='font14RB text-white !sm:text-sm !text-xs'>Rose</p>
                <p className='font14RB text-GRAY_101 !sm:text-sm !text-xs'>20124857</p>
              </div>
            </div>
