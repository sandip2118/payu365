...
import ImgBoxComp from '@/components/Common/ImgBoxComp'
  ...
  return (
    <Page title={title} isBreadcrumbs>
      <div className="w-full flex flex-col mb-5 sm:px-5 px-[10px] mt-[33.5px] items-center">
        ...
        {activeStep === 1 && (
          <Review activeStep={activeStep} _activeStep={_activeStep} />
        )}
        {activeStep === 2 && (
          <>
            <SuccessBox
              ...
              texts={
                <>
                  ...
                  <p className="font12RB mt-[15px] text-GRAY_101 !leading-[18px] text-center">
                    You have sent{' '}
                    <span className="text-white">$119.99 USD</span> to
                  </p>
                  <p className="font12RB text-GRAY_101 !leading-[18px] text-center">
                    ...
                    from your <span className="text-white">Pavan’s Wallet</span>{' '}
                    <span className="text-YELLOW_01">(Wallet ID: 447778)</span>
                  </p>
                </>
              }
              buttons={
                ...
                <div className="bg-BLACK_304 p-[10px] sm:p-[0px]">
                  <div className="bg-BLACK_303 pt-5 pb-[35px] rounded-[20px] relative flex flex-col items-center">
                    ...
                    <img
                      ...
                      alt="profile"
                      className="w-[68px] h-[68px] rounded-full bg-GRAY_101"
                    />
                    <p className="font24SMB sm:!text-2xl !text-lg text-white">
                      Jack Richer Dawson
                    </p>
                    <div className="flex items-center mt-[5px]">
                      <div className="w-[6px] h-[6px] rounded-full bg-GREEN_02 mr-[5px]" />
                      <p className="font14RB text-GREEN_02 !sm:text-sm !text-xs">
                        Active wallet - 9874
                      </p>
                    </div>
                    <p className="font30SMB sm:!text-3xl !text-2xl text-white">
                      ₹10,000.00
                    </p>
                  </div>
                  <div className="sm:px-[10px] px-0">
                    <p className="font22SB text-white mt-5">
                  ...
                  <div className="justify-center flex mb-5">
                    <button className="font14SB bg-BLUE_201 w-[195px] mt-[15px] text-white flex justify-center items-center sm:px-[42.5px] px-[20px] self-stretch h-[48px] font-semibold rounded-[5px]">
                      Get PDF Receipt
                    </button>
                  </div>
                </div>
