...
import DeactivateAcc from '@/components/SettingsV2/DeactivateAcc/DeactivateAcc'
...
function DeactivateWrapper() {
  const [activeTab, setActiveTab] = useState<settingsTabItem>(settingsTabs[8]);
...
export default DeactivateWrapper