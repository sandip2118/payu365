...
function PartTwo() {
  return (
    <CardWrapper>
       ...
       <SecuritySettings tag={false} icon={true} iconPath='/assets/icons/email.svg' title='Email' description='Use your email to protect your account and transactions.' extra={false} extraText='Having trouble ?' switch={true} switchIcon={false}  switchText='Off' buttonText="Manage" isBorder={true} component='ManageEmail' tabTitle='Manage Email'/>
       <SecuritySettings tag={false} icon={true} iconPath='/assets/icons/phoneNo.svg' title='Phone Number' description='Use your phone number to protect your account and transactions.' extra={false} extraText='Having trouble ?' switch={true} switchIcon={true}  switchText='+91 81******88' buttonText="Manage" isBorder={true} component='ManagePhoneNo' tabTitle='Manage Mobile Number'/>
       <SecuritySettings tag={false} icon={true} iconPath='/assets/icons/loginPass.svg' title='Login Password' description='Use your phone number to protect your account and transactions.' extra={false} extraText='Having trouble ?' switch={true} switchIcon={true}  switchText='Off' buttonText="Manage" isBorder={false} component='ManagePasswword' tabTitle='Manage Login Password'/>
    </CardWrapper>
  )
}
