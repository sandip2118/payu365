...
import ConnectedAccounts from '@/components/SettingsV2/ConnectedAccounts/ConnectedAccounts'
...
function ConnectedAccWrapper() {
  const [activeTab, setActiveTab] = useState<settingsTabItem>(settingsTabs[6]);
...
export default ConnectedAccWrapper;